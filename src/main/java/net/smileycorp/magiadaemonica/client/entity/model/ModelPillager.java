package net.smileycorp.magiadaemonica.client.entity.model;
...
import net.smileycorp.magiadaemonica.integration.ModIntegration;
import net.smileycorp.magiadaemonica.integration.crossbows.CrossbowsBackportIntegration;
